...
Thank you for visiting the MACO Calculation App! This tool is actively being developed and may have bugs — especially in file uploading (templates, multi-file) and result accuracy. **Please do not use this app for official or critical calculations at this stage.**
...
This app is 100% free and built individually with limited resources. If you know Python, Java, HTML, or related tech and want to help, please reach out!
